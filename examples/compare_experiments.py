...
def summarize_experiment(exp: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "target_entropy_avg": training.get("target_entropy_avg"),
        "mcts_visit_policy_updates": training.get("mcts_visit_policy_updates"),
        "chosen_action_policy_updates": training.get("chosen_action_policy_updates"),
    ...
    for exp in experiments:
        overview_rows.append(
            [
                ...
                str(exp.get("mcts_visit_policy_updates") if exp.get("mcts_visit_policy_updates") is not None else NUMERIC_NA),
                str(exp.get("chosen_action_policy_updates") if exp.get("chosen_action_policy_updates") is not None else NUMERIC_NA),
                _float_text(exp.get("target_entropy_avg")),
